...
QT_TRANSLATE_NOOP("bitcoin-core", "-walletrbf is deprecated and will be fully removed in the next release."),
QT_TRANSLATE_NOOP("bitcoin-core", "A %zu MiB dbcache may be too large for a system memory of only %zu MiB."),
QT_TRANSLATE_NOOP("bitcoin-core", "A fatal internal error occurred, see %s for details: %s"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Error: Could not add tx %s to watchonly wallet"),
QT_TRANSLATE_NOOP("bitcoin-core", "Error: Could not add watchonly tx %s to watchonly wallet"),
QT_TRANSLATE_NOOP("bitcoin-core", "Error: Could not create file '%s'"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Error: Export destination '%s' already exists"),
QT_TRANSLATE_NOOP("bitcoin-core", "Error: Export destination cannot be empty"),
QT_TRANSLATE_NOOP("bitcoin-core", "Error: Failed to create new watchonly wallet"),
QT_TRANSLATE_NOOP("bitcoin-core", "Error: Failed to create new watchonly wallet. %s"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Error: Unable to write the exported wallet"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Error: Wallet has no descriptors to export"),
QT_TRANSLATE_NOOP("bitcoin-core", "Error: cannot commit db transaction for watchonly wallet export"),
QT_TRANSLATE_NOOP("bitcoin-core", "Error: cannot remove legacy wallet records"),
QT_TRANSLATE_NOOP("bitcoin-core", "Error: database transaction cannot be executed for new watchonly wallet %s"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Prune mode is incompatible with a txindex that still contains legacy entries. Stop the node, delete the txindex directory, and restart to rebuild the index."),
QT_TRANSLATE_NOOP("bitcoin-core", "Prune mode is incompatible with a txospenderindex that still contains legacy entries. Stop the node, delete the txospenderindex directory, and restart to rebuild the index."),
...
QT_TRANSLATE_NOOP("bitcoin-core", "The -testactivationheight option may not be used on mainnet."),
QT_TRANSLATE_NOOP("bitcoin-core", "The -vbparams option may not be used on mainnet."),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Unable to write descriptor cache"),
