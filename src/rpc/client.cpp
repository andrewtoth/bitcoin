...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "getscripthistory", 1, "verbosity" },
    { "getscripthistory", 1, "verbose" },
    { "getscripthistory", 2, "options" },
    { "getscripthistory", 2, "start_height" },
    { "getscripthistory", 2, "end_height" },
    { "getscripthistory", 2, "include_mempool" },
    { "getscripthistory", 2, "range" },
